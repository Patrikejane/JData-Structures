...
class BubbleSortTest {
    ...
    public void testSortWithUnsortedArray() {
        ...
        Integer[] sortedArray = BubbleSort.sort(unsortedArray, arraySize);
    ...
    public void testSortWithAlreadySortedArray() {
        ...
        Integer[] resultArray = BubbleSort.sort(sortedArray, arraySize);
    ...
    public void testSortWithEmptyArray() {
        ...
        Integer[] sortedArray = BubbleSort.sort(emptyArray, arraySize);
